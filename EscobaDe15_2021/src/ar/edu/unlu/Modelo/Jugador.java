...
public class Jugador {
	...
	public Carta tirarCarta(Integer numero) {
		...
		return carta;											//retorna una carta que será agregada a la mesa
	}
	
	//funcion con la cual el jugador, con una carta de su mano y cartas que eligió de la mesa para hacer baza
